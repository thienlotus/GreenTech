...
if (!function_exists('translate_pest_name_vi')) {
    function translate_pest_name_vi($name) {
        ...
        $exact_map = array(
            ...
            'asiatic rice borer' => 'Sâu đục thân châu Á',
            'yellow rice borer' => 'Sâu đục thân vàng',
            'leaf folder' => 'Sâu cuốn lá',
            'leaf roller' => 'Sâu cuốn lá',
            'rice leaf roller' => 'Sâu cuốn lá lúa',
            'rice leaf caterpillar' => 'Sâu ăn lá lúa',
            'rice stemfly' => 'Ruồi đục thân lúa',
            'rice gall midge' => 'Muỗi hành hại lúa',
            'paddy stem maggot' => 'Dòi đục thân lúa',
            'armyworm' => 'Sâu keo',
            ...
            'caterpillar' => 'Sâu non',
            'cutworm' => 'Sâu xám',
            'mole cricket' => 'Dế nhũi',
            'wireworm' => 'Sâu kim',
            'termite' => 'Mối',
            'unknown bug' => 'Côn trùng chưa xác định',
            'unknown_bug' => 'Côn trùng chưa xác định',
